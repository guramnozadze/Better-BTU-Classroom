...
Speed up course selection during registration by filtering the course table to show only **courses offered this semester** and hiding **failed classes**. This makes the table much more compact and easier to scan when course selection is competitive and popular courses can fill up quickly.
